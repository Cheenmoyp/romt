...
These Conditions must be read in conjunction with any other applicable terms and conditions governing the use of the Site.
			...
			<h4>Trademarks</h4>
			<p>The Site contains “ROMT” trade and service marks and devices (including the word “ROMT”) and other valuable trade or service marks owned by ROMT or licensed to ROMT to distinguish its services and products. These trade and service marks and related intellectual property are protected from copying and simulation under national and international laws and may not be reproduced or copied without the express prior written consent of ROMT.
Without limitation, you must not use any of the said trade or service marks:
          ...
          <ul>
			...
			<li>in connection with activities, products or services which are not undertaken or provided by ROMT;</li>
			<li>in a manner which may be confusing, misleading or deceptive; or</li>
			<li>in a manner that disparages ROMT or its information, products or services (including this Site).</li>
			...
			<h2>Copyright</h2>
			<p>
				The information, text, graphics, images, sounds, links and all other information and software published or otherwise contained in the Site (“Information”) are either owned exclusively by ROMT or licensed by ROMT and except as specifically provided in these Conditions may not be copied, distributed, displayed, reproduced or transmitted, in any form or by any means whether electronic, mechanical, photocopying, recording, or otherwise, without the prior written approval of ROMT. Without limitation you may not, without such approval from ROMT, create derivative works from any part of the Site or commercialise any Information, products or services obtained from any part of the Site. Information procured from a third party may be the subject of copyright owned by that third party.  
			</p>
			
			 <h2>Your Use</h2>
				  
			<p>The Site is for your personal non commercial use and the Information may be downloaded or printed by you solely for that purpose.
This right to use the Information is a license only, not a transfer of title, and is subject to the following restrictions:
</p>
				  <ul>
					<li>the Information may not be used for any commercial purpose or public display, performance, sale or rental;</li>
					<li>no copyright or other proprietary notices may be removed:</li>
					<li>the Information may not be transferred to another person;</li>
					<li>software may not be interfered with in any manner;</li>
					<li>every person downloading, reproducing or otherwise using the Information must prevent any unauthorized copying of the Information;</li>
					<li>you will only use the Information for lawful purposes and in accordance with these Conditions.</li>
...
Whilst ROMT seeks to ensure that the Information is reliable and accurate, errors and omissions may occur and therefore, to the extent permitted by law, ROMT does not make or give any representation or warranty (express or implied) of any kind as to any matter relating to the Site and any Linked Web Site, including without limitation, as to merchantability, non infringement of intellectual property rights or fitness for purpose.
In particular ROMT does not warrant that:
						<ol>
							<li> the Information or any other material accessed through the Site including via any Linked Web Site is reliable, accurate or complete including, without limitation, information relating to prices and availability; or</li>
							<li> your access to Information or any other material accessed through the Site including via any Linked Web Site will be uninterrupted, timely or secure.</li>

						
						</ol>
				  <br/>
				  
				  ROMT is not liable for any loss (direct or indirect) resulting from any action taken or reliance made by you on the Information or any other material accessed through the Site including via any Linked Web Site. You should make your own inquiries and seek independent professional advice before acting or relying on any such information or material.
...
ROMT does not guarantee that the Site will operate continuously or without interruption or be error free. In addition, ROMT may also suspend or discontinue any aspect of the Site at any time without being liable for any direct or indirect loss as a result of such action.
				  ...
				  <p>
				  In no event shall ROMT be responsible for any direct, indirect, special, incidental or consequential loss or damage, however arising and whether in contract, tort or otherwise, which you may suffer in connection with or arising out of:
						<ul>
							<li> your use of the Site or any Linked Web Site; or</li>
							<li> your use of or reliance on Information or any other material accessed through the Site including via any Linked Web Site;</li>
...
Where applicable law implies any warranty, term or condition, and that law prohibits exclusion or modification of the application of or the liability of ROMT under, any such warranty, term or condition, then the liability of ROMT shall include liability for that warranty, term or condition but such liability will be limited for a breach of that warranty, term or condition to one or more of the following:
						<ul>
							<li> 	if the breach relates to services, the supply of the services again or payment of the cost of having the services supplied again; and</li>
				  ...
				  <p>
				  You must ensure that your access to and your use of the Site is not illegal or prohibited by laws which apply to you.<br/>
You must take your own precautions that the process which you employ for accessing the Site does not expose you to the risk of virus, malicious computer code, computer program routine or process or other forms of interference which may damage your own computer system. Without limitation, you are responsible for ensuring that your own computer system meets all relevant technical specifications necessary to use the Site and is compatible with the Site. For the removal of doubt, ROMT does not accept responsibility for any interference or damage to your own computer system which arises in connection with your use of the Site or any Linked Web Site.<br/>
ROMT does not guarantee or warrant that any material available for downloading from the Site or any Linked Web Site will be free from any virus, infection or other condition which has contaminating or destructive properties. You are responsible for taking sufficient precautions and checks to satisfy your own particular requirements for accuracy of data input and output.
You must ensure that any information which you provide to ROMT is accurate and complete and does not contain any virus, malicious computer code, computer program routine or process or other form of interference which may damage the computer system of ROMT or the Information or which may detrimentally interfere with or surreptitiously intercept or expropriate any ROMT system, data or information.
...
The Site contains details of hotel charges and room rates (including any available special offers) for hotels and resorts owned or managed by ROMT.<br/>
...
No contract will subsist between you and ROMT or any of its affiliates in respect of any services or products offered through the Site unless and until ROMT accepts your order by e-mail or automated confirmation through the Site confirming that it has accepted your reservation, booking or order and any such contract shall be deemed to incorporate the hotel reservation terms and conditions of booking. Any other relevant terms and conditions relating to particular services or products are set out in the Site.
You undertake that all details you provide to in connection with any services or products which may be offered by ROMT on the Site (including hotel room reservations) will be correct and, where applicable, the credit card which you use is your own and that there are sufficient funds to cover the cost of any services or products which you wish to purchase. ROMT reserves the right to obtain validation of your credit card details before providing you with any services or products.

				  </p>
				  
				  
				  <h2>Security & Non Confidentiality</h2>
				  
				  <p>Electronic transmissions of data including the Internet are public media and any use of such media is public not private.
...
ROMT does not warrant and cannot ensure the security or confidentiality of any information which you transmit to ROMT. Accordingly, any information which you transmit to ROMT is transmitted at your own risk.
</p>
		
		
		<h2>Termination of Access</h2>
		<p>If you breach any of these Conditions your license to use the Site will terminate immediately without the necessity of any notice being given to you.
Otherwise access to the Site may be terminated at any time by ROMT without notice.
The provisions of these Conditions excluding, limiting and disclaiming the liability of ROMT will nevertheless survive any such termination.
</p>
		<h2>General</h2>
		
		<p>ROMT does not accept any liability for any failure by ROMT to comply with these Conditions where such failure is due to circumstances beyond its reasonable control.
If ROMT waives any rights available to it under these Conditions on one occasion, this does not mean that those rights will automatically be waived on any other occasion.

            ...
            <div className="inner-page-wrapper">
                <div className="packages-page-banner">
                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active"> <img src="/Images/packages/packages-slider1.jpg" className="d-block w-100" alt="..."/> </div>
                        <div className="carousel-item"> <img src="/Images/packages/packages-slider1.jpg" className="d-block w-100" alt="..."/> </div>
                    </div>
